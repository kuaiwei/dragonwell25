...
/*
  typedef HashTable<InstanceKlass*, DumperClassCacheTableEntry*,
                    TABLE_SIZE, AnyObj::C_HEAP, mtServiceability> PtrTable;
// >>>>>>> 296fe862f73 (8341771: [lworld] Heap dump recognizing new flat fields formats)
*/
  PtrTable* _ptrs;
...
public:
  ...
  virtual uintptr_t get_id() override {
    ...
    uintptr_t old_value = Atomic::load(&_id_counter);
    while (old_value != max_value) {
      ...
      uintptr_t value = Atomic::cmpxchg(&_id_counter, old_value, new_value);
      if (value == old_value) {
        // success
        return new_value;
      }
